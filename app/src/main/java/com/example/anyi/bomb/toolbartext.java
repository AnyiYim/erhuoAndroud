...
//        });
        ...
        if(bmobUser != null){
            username.setText(bmobUser.getNick());
            if (bmobUser.getSex()) {
                Glide.with(getApplicationContext()).load(R.drawable.boy).into(userlogo);
            }
            else {
                Glide.with(getApplicationContext()).load(R.drawable.girl).into(userlogo);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.sell:
                if(bmobUser != null){
                    startActivity(new Intent(toolbartext.this, textalbumActivity.class));
                    //finish();
                    // 允许用户使用应用
                }else{
                    startActivity(new Intent(toolbartext.this, Login.class));
            ...
            case R.id.buy:
                if(bmobUser != null){
                    startActivity(new Intent(toolbartext.this, buytext.class));
                    //finish();
                    // 允许用户使用应用
                }else{
                    startActivity(new Intent(toolbartext.this, Login.class));
