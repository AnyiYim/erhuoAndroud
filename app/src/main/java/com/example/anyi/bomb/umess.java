...
public class umess extends AppCompatActivity {
...
*/
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.umess);
        Intent intent = getIntent();
        final String bID = intent.getStringExtra("extra_Mdata");
            ...
            public void onClick(View v) {
                ...
                p2.delete(new UpdateListener() {
                    ...
                    public void done(BmobException e) {
                        if(e==null){
                            finish();
                            Intent intent = new Intent(umess.this, userPro.class);
                            startActivity(intent);
                        }
                    }
