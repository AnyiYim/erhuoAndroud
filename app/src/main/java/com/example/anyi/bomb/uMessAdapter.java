...
public class uMessAdapter extends RecyclerView.Adapter<uMessAdapter.ViewHolder>{
    ...
    public uMessAdapter(List<buymess> textList) {
        mText = textList;
    }

    @Override
    public uMessAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mContext == null) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, umess.class);
    ...
    @Override
    public void onBindViewHolder(final uMessAdapter.ViewHolder holder, final int position) {
        String name;
        String mess;
        //BmobFile image;
